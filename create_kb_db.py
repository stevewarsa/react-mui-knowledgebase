...
createEntry = "CREATE TABLE kb_entry (id integer primary key autoincrement, title text not null, description text not null, markdown BOOLEAN NOT NULL CHECK (markdown IN (0, 1)), appl_create_dt DATETIME NOT NULL DEFAULT (CURRENT_TIMESTAMP));"
